...
const socialLinks = [
  { icon: GithubIcon, href: "https://github.com/khadka27", label: "GitHub" },
  {
    icon: LinkedinIcon,
...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className="relative section-shell overflow-hidden">
      <div
      ...
      <div className="relative z-10">
        ...
        <div className="mx-auto mb-12 max-w-3xl text-center md:mb-16">
          ...
          >
            ...
            <span
              className="h-px w-16 max-w-full bg-linear-to-r from-transparent via-primary/40 to-transparent"
              aria-hidden
            />
          </motion.div>
          <motion.h2
