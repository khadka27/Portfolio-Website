...
interface Cert {
  ...
  issuer: string;
  date: string;
  badge: string; // emoji or icon color class
          ...
          >
            ...
            >
              ...
              <div className="flex items-start gap-3">
                <div className={`text-2xl w-12 h-12 rounded-xl bg-muted flex items-center justify-center flex-shrink-0 border border-border text-2xl`}>
                  {cert.badge}
                </div>
